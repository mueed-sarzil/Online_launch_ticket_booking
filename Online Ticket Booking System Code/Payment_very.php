<html>
	...
	<head>
		<title>Passenger Details|Ticket.com</title>
		<style>
	...
	<body>
		...
		<div align="center">
			...
			<p>Our Bkash merchant number is <b style="color: red;">01747049043</b> Follow the payment option and give reference number <b style="color: red;">1</b> </p>
				<table align="center">
				...
				<tr>
					<td>
							...
							<table>
								<label>Merchant No:01747049043</label>
								<tr>
									<td>
										<input class="div" type="text" placeholder="017XXXXXXXX" name="mobile">
									</td>
								</tr>
								<tr>
									<td>
			...
			?>
				...
				<div align="center">
					...
					<img src="bKash-payment.jpg" width="500">
				</div>
