...
.error{color: red;}
	...
	<body>
		...
		<?php include 'showcabin.php'; showdata(); ?>
		<!--validation-->
		<?php  
	...
	?>
		<h1>Cabin Information</h1>
		
		<table >
		<input type="hidden" name="id" value="<?php echo $id; ?>">
		<tr>
			<td>
 			  <input  type="text" placeholder="Enter Launch Name" name="lnname">
		...
		<tr>
			<td>
				<input class="div" type="text" placeholder="Enter cabin no" name="cn">
		...
		<div>
			...
			<?php 
				...
				else
				{
					...
					$sql="INSERT INTO cabininfo VALUES('','$cabclass','$seatno','$fare','$status','$cabinno','$launchname')";
